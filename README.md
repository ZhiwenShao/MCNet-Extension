This face alignment tool is based on Caffe [1]. It is the C++ implementation of our method MCNet. The testing code of the earlier version can be found [here](https://github.com/ZhiwenShao/MCNet). 
